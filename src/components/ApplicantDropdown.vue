...
<div id="wrapper">
  ...
  <i class="fa fa-github"><a href="www.github.com"><h2> GITHUB</h2></a></i>
    ...
    <h2>The current applicant score is : {{status+status1}} out of 10</h2><br>
    <v-btn color="orange" class="button1" v-on:click="status=0">RESET SCORE</v-btn>
    <br>
    <br>
    <v-btn color="blue" class="button2" v-on:click="status">SUBMIT SCORE</v-btn>
        </section>
          <section id="right">
  <v-flex>
     <v-card>
          <iframe :src="resumeLink" style="width:700px; height:900px;"></iframe>
        </v-card>
      </v-flex>
      </section>
    </v-layout>
...
export default {
  ...
  data: () => ({
    ...
    status: 0,
    status1: 0,
    resumeLink: 'https://drive.google.com/viewerng/viewer?embedded=true&url=https://writing.colostate.edu/guides/documents/resume/functionalSample.pdf',
    cards: [
      {
        title: 'Pre-fab homes',
        flex: 12,
